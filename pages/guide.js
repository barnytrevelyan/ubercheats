...
const STEPS = [
  ...
  },
  {
    ...
    content: [
      ...
      'Warning: Uber has been known to ban accounts after successful chargebacks. Consider whether you still want to use the platform before proceeding.',
    ],
...
const COUNTRY_TIPS = [
  ...
  { flag: '🇺🇸', country: 'United States', tips: ['FTC complaint at reportfraud.ftc.gov — your complaint directly contributes to the active FTC v. Uber case.', 'CFPB handles payment disputes and requires a company response within 15 days.', 'Small claims: Uber typically settles within 30 days of a filing. File in your home state.', 'California AB 578 (2024): Uber Eats must issue full refunds for undelivered orders — no discretion.'] },
  { flag: '🇦🇺', country: 'Australia', tips: ['ACCC already fined Uber $21M for misleading consumers — they take these complaints seriously.', 'Australian Consumer Law mandates refunds for services not provided.', 'AFCA (Australian Financial Complaints Authority) handles chargeback escalations — free and legally binding.'] },
